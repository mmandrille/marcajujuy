"""
Django settings for JujuyGob project.
...
SECRET_KEY = 'kjtjf9mfys+0^*4%nwrvpg9o&)4hb405hs*74cw_wt+aphn%=1'
...
WSGI_APPLICATION = 'MarcaJujuy.wsgi.application'
...
BASE_DIR = os.path.realpath(os.path.dirname(__file__))[:-10]
MEDIA_URL = 'archivos/'
